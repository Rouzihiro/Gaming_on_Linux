#!/usr/bin/env bash
# ==============================================================
# Proton/FEX Game Launcher (Asahi ARM optimized)
#
# usage
# muvm bash
# ./runner.sh WoW.exe
# --------------------------------------------------------------
# Features:
#   ✅ Automatic Proton + Prefix setup
#   ✅ Works inside muvm/FEX or native shell
#   ✅ Steam-style launch args support
#   ✅ DXVK, VKD3D, FEX, and Mesa environment tuning
#   ✅ Auto per-game logging in ~/Games/logs/
# ==============================================================

set -euo pipefail

# ----[ USER CONFIGURATION ]------------------------------------
PROTON_DIR="$HOME/.steam/root/steamapps/common/Proton 9.0 (Beta)/"
STEAM_PATH="$HOME/.steam/root"
LOG_DIR="$HOME/Games/logs"
mkdir -p "$LOG_DIR"

# Optional: edit to use a specific Proton build
...
# FEX (ARM emulator) options — helps with 32/64-bit Wine bridge stability
...
echo "🕹️  Game: $GAME_EXE $EXTRA_ARGS" | tee -a "$LOGFILE"
...
echo "=============================================================" | tee -a "$LOGFILE"
echo "🏁 Game exited with code $EXIT_CODE" | tee -a "$LOGFILE"
